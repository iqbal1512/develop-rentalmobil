                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <?php if ($status === 'proses'): ?>
                        <a href="<?= base_url('pembelian/selesai/' . $p['id_pembelian']) ?>" class="btn btn-sm btn-outline-success" 
                           onclick="return confirm('Selesaikan transaksi? Stok mobil akan otomatis bertambah.')">
                      ...
                      <?php endif; ?>
                      <a href="<?= base_url('pembelian/delete/' . $p['id_pembelian']) ?>" class="btn btn-sm btn-outline-danger" 
