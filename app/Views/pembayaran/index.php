...
<div class="card shadow-sm">
  <div class="card-header d-flex justify-content-between align-items-center bg-white text-dark">
    <h5 class="mb-0"><i class="bi bi-credit-card-2-front-fill text-info me-2"></i> Daftar Pembayaran Penjualan</h5>
  </div>
                  ...
                  <td class="text-center"> <div class="btn-group">
                      ...
                      <?php if ($status === 'menunggu'): ?>
                        <a href="#" 
                           ...
                           onclick="event.preventDefault(); confirmAction('<?= base_url('pembayaran/verifikasi/' . $b['id_pembayaran']) ?>', 'Verifikasi Pembayaran', 'Apakah Anda yakin ingin memverifikasi pembayaran ini?', 'question', 'Ya, Verifikasi', '#28a745')" title="Verifikasi">
                          <i class="bi bi-check-lg"></i>
                        </a>
                        <a href="#" 
                           class="btn btn-sm btn-outline-danger" 
                           onclick="event.preventDefault(); confirmAction('<?= base_url('pembayaran/tolak/' . $b['id_pembayaran']) ?>', 'Tolak Pembayaran', 'Apakah Anda yakin ingin menolak pembayaran ini?', 'warning', 'Ya, Tolak', '#dc3545')" title="Tolak">
